...
/* package my-haskell-app-0.1.0.0 */
#ifndef VERSION_my_haskell_app
#define VERSION_my_haskell_app "0.1.0.0"
#endif /* VERSION_my_haskell_app */
#ifndef MIN_VERSION_my_haskell_app
#define MIN_VERSION_my_haskell_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_haskell_app */
...
#define CURRENT_COMPONENT_ID "my-haskell-app-0.1.0.0-inplace-my-haskell-app-test"
